...
UNUSED_AUTOMAP_PARAMS = "SCP74 unused automap params"
MISSING_PROVIDER_PARAMS = "SCP75 missing provider params"
...
CALLBACK_CASES: Cases = tuple(
    ...
    for source, message in (
        # SCP74: the callback discards the response, so scrapy-poet skips the
...
""",
        ...
        # SCP75: the response is used, but the page objects are fetched through
