...
SESSION_ROTATION = (44, "session rotation")
UNSAFE_META_COPY = (45, "unsafe meta copy")
ZYTE_RAW_PARAMS = (46, "raw Zyte API params")
UNIMPORTABLE_COMPONENT = (47, "unimportable component")
DEPRECATED_SPIDER_ATTRIBUTE = (48, "deprecated spider attribute")
DEPRECATED_IMPORT = (49, "deprecated import")
REMOVED_IMPORT = (50, "removed import")
DEPRECATED_ARGUMENT = (51, "deprecated argument")
HARDCODED_SECRET = (53, "hardcoded secret")
UNNEEDED_START = (54, "unneeded start method")
UNSUPPORTED_CLASS_OBJECT = (56, "unsupported class object")
NO_ALLOWED_DOMAINS = (57, "no allowed_domains")
DOCUMENTATION_COMMENT = (58, "documentation comment")
LOWERCASE_SETTING = (59, "lowercase setting")
UNSORTED_PRIORITY_DICT = (60, "unsorted priority dict")
EOL_PYTHON = (63, "end-of-life Python")
STACK_PYTHON_MISMATCH = (64, "stack Python mismatch")
UNFROZEN_PYTHON = (65, "Python not frozen")
MISSING_COMPONENT_REQUIREMENT = (66, "missing component requirement")
START_URL = (67, "start_url instead of start_urls")
OLD_SELECTOR_GETTER = (68, "old selector getter")
ABSOLUTE_NESTED_XPATH = (69, "absolute XPath in nested selector")
NON_SPIDER_LOGGER = (70, "non-spider logger")
SCRAPY_VERSION_MISMATCH = (72, "Scrapy version mismatch")
...
WRONG_ADDON_ORDER = (80, "wrong add-on order")
