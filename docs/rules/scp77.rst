...
Reports uses of an API or a setting that is not deprecated yet in the package
versions frozen in your project requirements, but that you can already stop
using, and reports the package and version in which it becomes deprecated.
